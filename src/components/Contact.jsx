  ...
  const contactInfo = [
    {
      icon: <FaPhone />,
      title: "Phone",
      info: contactContent.phone || "+91 98765 43210",
      link: `tel:${contactContent.phone || "+91 98765 43210"}`,
    },
    {
      icon: <FaEnvelope />,
      title: "Email",
      info: contactContent.email || "info@megareality.com",
      link: `mailto:${contactContent.email || "info@megareality.com"}`,
    },
    {
      icon: <FaMapMarkerAlt />,
      title: "Address",
